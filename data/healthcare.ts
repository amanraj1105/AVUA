...
export const healthcareData: SectorData = {
  ...
  theme: {
    ...
    buttonGradient: "linear-gradient(to right, #7BB8FE, #1D6FF2)",
    buttonShadow: "0 6px 20px rgba(29, 111, 242, 0.35)",
  },
  hero: {
    badge: "Healthcare Recruitment Reimagined",
    titleLine1: "Care for People.",
    titleLine2Parts: [
  ...
  futureRecruitment: {
    ...
    employers: {
      ...
      stats: [
        ...
        { label: "Access global talent", sublabel: "Across all healthcare sectors" },
    ...
    professionals: {
      ...
      features: [
        ...
        { label: "Industry-specific resume tools", sublabel: "For clinical roles" },
        { label: "Project-based opportunities", sublabel: "With clear requirements" },
        { label: "Career development resources", sublabel: "For healthcare professionals" },
      ],
    },
  },
  careerSection: {
