...
export const roboticsData: SectorData = {
  ...
  theme: {
    ...
    buttonGradient: "linear-gradient(to right, #FE9BAB, #E63946)",
    buttonShadow: "0 6px 20px rgba(230, 57, 70, 0.35)",
  },
  hero: {
  ...
  futureRecruitment: {
    ...
    employers: {
      ...
      stats: [
        ...
        { label: "Access global talent", sublabel: "Across all robotics sectors" },
    ...
    professionals: {
      ...
      features: [
        { label: "Direct access", sublabel: "To verified robotics employers" },
        ...
        { label: "Career development resources", sublabel: "For robotics professionals" },
      ],
    },
  },
  careerSection: {
